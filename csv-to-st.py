...
preface_lines = []
with open("docs/style.md", "r", encoding="utf8") as readme:
...
with open("style.csv", "r", encoding="utf8") as supplement_csv:
    supplement_reader = csv.reader(supplement_csv)
    with open("docs/style.md", "w", encoding="utf8") as conj_md:  # WARNING: rewrites the file!
