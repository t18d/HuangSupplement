...
last_modified_at: 2024-09-12T01:24:47+00:00
---
...
This database is searchable as a [CSV file](https://github.com/t18d/HuangSupplement/blob/main/supplement.csv). The quickest way to get an addition or correction merged is to fork the repo or [clone locally](https://github.com/t18d/HuangSupplement/wiki/Clone-the-repo), edit the CSV file and send in a pull request. Assignment to word classes follows the scheme of Huang and Shi (2016). Script is not regularised except where it may cause confusion. The intention is to focus on words and forms which are still current in everyday usage, although antedatings of obsolete forms are welcome.  
<br>
<details>
    <summary>Bibliography</summary>

### Theory
- Huang, Chu-Ren, and Dingxu Shi (eds), <em>A Reference Grammar of Chinese</em>  (Cambridge, 2016).</li>
...
- A blank for **Quotation** means the scholar who antedated the word didn't supply the evidence in their writings.
- **Source**
...
- If you are in a place with internet restrictions, contact your local authorities and ask them to unblock the site for you. In the meantime, you can send the contributions to <span class="email">67616464787179717a6054607b7a7f617a6760787166397b7a39607c713976617a703a777b79</span>.
...
钟乳石|/|noun|1917|⋯石灰洞。洞內有上面。生鐘乳石。|『新制地理概论教本』|
